...
function estimateFontSize(text: string, startSize: number, maxWidth: number, minSize: number) {
  let size = startSize;
  while (size > minSize) {
...
export default function PalLabelCreatorPage() {
  ...
  const middleTextColor = autoTextColor ? getContrastTextColor(middleColor) : manualTextColor;
  const bottomTextColor = autoTextColor ? getContrastTextColor(bottomColor) : manualTextColor;
        ...
        >
          ...
          <div style={{ display: "grid", gap: 12 }}>
            ...
            <div>
              ...
              <input type="range" min="40" max="180" value={companyScale} onChange={(e) => setCompanyScale(Number(e.target.value))} style={{ width: "100%" }} />
            </div>
            <div>
            ...
            <div>
              ...
              <input type="range" min="5" max="30" value={companyY} onChange={(e) => setCompanyY(Number(e.target.value))} style={{ width: "100%" }} />
            </div>
            ...
            >
              ...
              {bandLogo ? (
                ...
                <>
                  <text
                    x={widthPx / 2}
                    y={artistLines.length > 1 ? contentTop + contentHeight * 0.40 : contentTop + contentHeight * 0.48}
                    textAnchor="middle"
